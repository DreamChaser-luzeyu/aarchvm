...
- Current Linux-facing platform path: low boot RAM alias, 1 GiB SDRAM, PL011 UART, PL031 RTC, Generic Timer, minimal GICv3, SDL framebuffer, PL050 KMI keyboard, virtio-mmio block/net transport, and perf mailbox.
