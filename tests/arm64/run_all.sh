...
run_expect fpsimd_unsigned_estimate.bin 300000 U
run_expect fpsimd_fmulx.bin 400000 X
run_expect fpsimd_fp_indexed_more.bin 500000 I
run_expect fpsimd_misc_more.bin 300000 G
run_expect fpsimd_pairwise_int_more.bin 300000 P
...
run_expect fpsimd_decode_overlap_undef.bin 400000 U
run_expect fpsimd_rev_vector.bin 400000 R
run_expect fpsimd_lookup_misc_more.bin 500000 L
run_expect fpsimd_cmp_zero_vector.bin 400000 Z
...
run_expect fpsimd_subtract_sat_more.bin 500000 S
